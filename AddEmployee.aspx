<%@ Page Title="Add an employee" Language="C#" MasterPageFile="~/Default.master" AutoEventWireup="true" CodeFile="AddEmployee.aspx.cs" Inherits="_Default" %>
            ...
            <div class="col-xs-12">
				    <div class="widget-box">
					  <%--  <div class="widget-title">
                         ...
                         <div ID="CatastrophicError" runat="server"></div>
					    <div class="widget-content nopadding">
                        <br />
                           <div ID="errorMsg" runat="server"></div>
                          <p class="lead">&nbsp;  <%--<a class="btn btn-success btn-xs" href="UploadEmployeeFile.aspx"><i class="fa fa-upload fa-white"></i> Upload a file </a> OR--%> Enter details below:</p>
                            ...
                            <div class="form-group" style="vertical-align:bottom" ID="jcDiv" runat="server">
                                ...
                                <div class="col-sm-9 col-md-9 col-lg-10">
                                    <asp:DropDownList  CssClass="addField"  ID="jobclass" runat="server" validate="false">
                                        <asp:ListItem Value="">Select... </asp:ListItem>
                                    </asp:DropDownList></div>
                            </div>
                            ...
                            <div class="form-actions"> 
                                <asp:LinkButton ID="BtnAdd" onclick='AddEmployee' runat="server" CssClass="btn btn-info" ClientIDMode="Static">
...
<asp:Literal ID="javascript" runat="server" />
    ...
    <script type="text/javascript">
        ...
        $(window).load(function () {
            ...
            if ($("#body_CatastrophicError").text().trim().length) {
                $(".widget-content").fadeTo(100, 0.2);
            }
