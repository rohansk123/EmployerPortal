...
<asp:Content ID="Content2" ContentPlaceHolderID="body" Runat="Server">
  <form class="form-horizontal" id="CensusForm" runat="server">
			<%--<div class="widget-title">
				...
				<h5><span id="MainContent_header">Add Employee Data</span></h5>
			</div>--%>
     	<%--<div class="row">
            <div class="col-xs-12">--%>
				    <div class="widget-box">
					  <%--  <div class="widget-title">
					    ...
					    <div class="widget-content nopadding">
		                   <table id="censusTable" class="table table-condensed table-bordered">
                <tbody><tr><td width="25%" valign="top" align="left">
                                <label class="col-sm-3 col-md-3 col-lg-2 control-label" for="fname"> First Name:</label></td>
                                <td valign="top" align="left">
                                    <asp:TextBox CssClass="addField" name="fname" ID="fname" MaxLength="35" runat="server" /></td></tr>
                            
		                     <tr><td width="25%" valign="top" align="left">
                                <label class="col-sm-3 col-md-3 col-lg-2 control-label" for="lname"> Last Name:</label></td>
                               <td valign="top" align="left">
                                    <asp:TextBox CssClass="addField" name="lname" ID="lname" MaxLength="35" runat="server" />                           
                            </td></tr>
		                    <tr><td width="25%" valign="top" align="left">
                                <label class="col-sm-3 col-md-3 col-lg-2 control-label" for="sex"> Gender:</label></td>
                                 <td valign="top" align="left"><asp:DropDownList CssClass="addField"  ID="sex" runat="server">
                                    <asp:ListItem value="">Select..</asp:ListItem>
                                    <asp:ListItem value="Male">Male</asp:ListItem>
                                    <asp:ListItem value="Female">Female</asp:ListItem></asp:DropDownList></td></tr>
                            </tbody>
                            </table>
                            ...
                            <div class="form-group" style="vertical-align:bottom">
                                ...
                                <div class="col-sm-9 col-md-9 col-lg-10">
                                    <asp:DropDownList  CssClass="addField"  ID="payGroup" runat="server">
                                        <asp:ListItem Value="">Select... </asp:ListItem>
                                        <asp:ListItem Value="BM">Bi-weekly</asp:ListItem>
