...
public partial class Test_Default : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        Session["currentAgency"] = "benefitsdirect";
        Session["group"] = "demo";
    ...
    private void SendEmail()
    {
        try
        {
            ...
            myReader = new SqlCommand("SELECT  [acct_manager],[acct_mgr_email] FROM [" + Session["currentAgency"] + "].[general].[Groups]", myConnection).ExecuteReader();
            while (myReader.Read())
            {
